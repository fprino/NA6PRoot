...
class NA6PTrack
{
 public:
  ...
  bool propagateParamToZ(float z, float by) { return mExtTrack.propagateParamOnlyTo(z, by); }
  bool propagateToZ(float z, float by) { return mExtTrack.propagateTo(z, by); }
